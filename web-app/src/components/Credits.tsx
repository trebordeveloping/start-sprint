...
export default function Credits() {
  ...
  return (
    ...
    <div className="group relative inline-flex items-center px-6 py-3 bg-white/90 backdrop-blur-sm text-gray-800 font-semibold rounded-full border border-gray-200/50 shadow-lg hover:bg-white hover:shadow-xl hover:scale-105 transform transition-all duration-300 ease-in-out">
      ...
      <div className="absolute top-full right-0 mt-2 w-72 bg-white/95 backdrop-blur-sm rounded-2xl border border-gray-200/50 shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transform translate-y-2 group-hover:translate-y-0 transition-all duration-300 ease-out z-20">
        <div className="p-6">
          {/* Reset Button */}
          <button
            onClick={resetCreditsAndPlaces}
